...
#define SWIGTYPE_p_std__complexT_float_t swig_types[3]
...
/*-----------------------------------------------
              @(target):= _pyNetCam.so
  ------------------------------------------------*/
#define SWIG_init    init_pyNetCam

#define SWIG_name    "_pyNetCam"
 ...
 */
//seb #define is_array(a)            ((a) && PyArray_Check((PyArrayObject *)a))
...
//seb
//array_signed_int_type_withItemSize
#define intarray_type_isize(a,i)  (PyArray_ISSIGNED(a) && PyArray_ITEMSIZE(a)==(i))
#define uintarray_type_isize(a,i) (PyArray_ISUNSIGNED(a) && PyArray_ITEMSIZE(a)==(i))
...
char* pytype_string(PyObject* py_obj) {
  ...
  if (py_obj == Py_None)        return "<None>"      ; // seb
  return "unkown type";
}
...
//BAD  char* type_names[20] = {"char","unsigned byte","byte","short",
//BAD			  "unsigned short","int","unsigned int","long",
//BAD			  "float","double","complex float","complex double",
//BAD			  "object","ntype","unkown"};
//from arrayobjct.h:   enum NPY_TYPES {
char* type_names[20] = {
  "bool",
  "byte", 
  "ubyte",
  ...
  return (typecode>=0 && typecode<18)? type_names[typecode] : (char*)"unknown";
}
...
//seb added:
/* Test whether a python array is non-byteswapped.  If array is
 * byteswapped, return 1.  Otherwise, set the python error string and
 * return 0.
 */
int require_native(PyArrayObject* ary) {
  int native = 1;
  if (!array_is_native(ary)) {
    PyErr_SetString(PyExc_TypeError, "Array must have native byteorder.  A byteswapped array was given");
    native = 0;
  }
  return native;
}
...
SWIGINTERN int Swig_var_count_set(PyObject *_val) {
  {
    int val;
    int res = SWIG_AsVal_int(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""count""' of type '""int""'");
    }
...
SWIGINTERN PyObject *Swig_var_count_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(count));
  return pyobj;
}


SWIGINTERN int Swig_var_q_set(PyObject *_val) {
  {
    int val;
    int res = SWIG_AsVal_int(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""q""' of type '""int""'");
    }
    q = static_cast< int >(val);
  }
  return 0;
fail:
  return 1;
...
SWIGINTERN PyObject *Swig_var_q_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(q));
  return pyobj;
}


SWIGINTERN PyObject *_wrap_thrTest(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  ...
  PyObject * obj1 = 0 ;
  char *  kwnames[] = {
    (char *) "hEvent",(char *) "dt", NULL 
  };
  
  if (!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"OO:thrTest",kwnames,&obj0,&obj1)) SWIG_fail;
  {
    arg1 = (long)(SEB_As_long(obj0));
    if (SWIG_arg_fail(1)) SWIG_fail;
  }
  {
    arg2 = (int)(SEB_As_int(obj1));
...
SWIGINTERN PyObject *_wrap_correct(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  PyObject *resultobj = 0;
  ...
  PyObject * obj15 = 0 ;
  char *  kwnames[] = {
    (char *) "array2d",(char *) "array1d",(char *) "array2d",(char *) "baseOffset",(char *) "array2d",(char *) "array2d",(char *) "corrRot",(char *) "correctMode",(char *) "darkLeft",(char *) "darkRight",(char *) "darkTop",(char *) "darkBottom",(char *) "skipLeft",(char *) "skipRight",(char *) "skipTop",(char *) "skipBottom", NULL 
  };
  ...
  arg28 = &temp28;
  arg29 = &temp29;
  if (!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"OOOOOOOOOOOOOOOO:correct",kwnames,&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8,&obj9,&obj10,&obj11,&obj12,&obj13,&obj14,&obj15)) SWIG_fail;
  {
    ("debug: ""Ushort"" *array2d  -> NA_InputArray\n");
    temp1 = obj_to_array_no_conversion(obj0, NPY_USHORT);
    //PyArrayObject *NAimg  = NA_InputArray(obj0, NPY_USHORT, NUM_C_ARRAY);
    
    if (!temp1  || !require_contiguous(temp1) || !require_native(temp1)) SWIG_fail;
    
    arg1 = (unsigned short *) temp1->data;
    /*@SWIG:Y:/code/PriithonSrc_py25/common\\sebTypemaps2.i,37,MAP_SHAPE2D@*/  switch(temp1->nd) {
    case 1:
      arg2 = temp1->dimensions[0];
      arg3=1;
      break;
    case 2:
      arg2 = temp1->dimensions[1];
      arg3=temp1->dimensions[0];
      break;
    default:
      (" **** array dim >2 (ns=%d)\n", temp1->nd);
  ...
  {
    ("debug: ""int"" *array1d  -> NA_InputArray\n");
    temp4 = obj_to_array_no_conversion(obj1, NPY_INT);
    //PyArrayObject *NAimg  = NA_InputArray(obj1, NPY_INT, NUM_C_ARRAY);
    
    if (!temp4  || !require_contiguous(temp4) || !require_native(temp4)) SWIG_fail;
    
    arg4 = (int *) temp4->data;
    /*@SWIG:Y:/code/PriithonSrc_py25/common\\sebTypemaps1.i,47,MAP_SHAPE1D@*/  switch(temp4->nd) {
    case 1:
      arg5 = temp4->dimensions[0];
      break;
    default:
      (" **** array dim  (ns=%d)\n", temp4->nd);
      {
        int a=1; for(int i=0;i<temp4->nd;i++) a*=temp4->dimensions[i];
        arg5 = a; 
      }
    }
    /*@SWIG@*/
  ...
  {
    ("debug: ""Ushort"" *array2d  -> NA_InputArray\n");
    temp6 = obj_to_array_no_conversion(obj2, NPY_USHORT);
    //PyArrayObject *NAimg  = NA_InputArray(obj2, NPY_USHORT, NUM_C_ARRAY);
    
    if (!temp6  || !require_contiguous(temp6) || !require_native(temp6)) SWIG_fail;
    
    arg6 = (unsigned short *) temp6->data;
    /*@SWIG:Y:/code/PriithonSrc_py25/common\\sebTypemaps2.i,37,MAP_SHAPE2D@*/  switch(temp6->nd) {
    case 1:
      arg7 = temp6->dimensions[0];
      arg8=1;
      break;
    case 2:
      arg7 = temp6->dimensions[1];
      arg8=temp6->dimensions[0];
      break;
    default:
      (" **** array dim >2 (ns=%d)\n", temp6->nd);
      SWIG_exception(SWIG_RuntimeError, " array dim > 2");
  ...
  {
    arg9 = (float)(SEB_As_float(obj3));
    if (SWIG_arg_fail(9)) SWIG_fail;
  }
  {
    ("debug: ""float"" *array2d  -> NA_InputArray\n");
    temp10 = obj_to_array_no_conversion(obj4, NPY_FLOAT);
    //PyArrayObject *NAimg  = NA_InputArray(obj4, NPY_FLOAT, NUM_C_ARRAY);
    
    if (!temp10  || !require_contiguous(temp10) || !require_native(temp10)) SWIG_fail;
    
    arg10 = (float *) temp10->data;
    /*@SWIG:Y:/code/PriithonSrc_py25/common\\sebTypemaps2.i,37,MAP_SHAPE2D@*/  switch(temp10->nd) {
    case 1:
      arg11 = temp10->dimensions[0];
      arg12=1;
      break;
    case 2:
      arg11 = temp10->dimensions[1];
      arg12=temp10->dimensions[0];
      break;
    default:
      (" **** array dim >2 (ns=%d)\n", temp10->nd);
      SWIG_exception(SWIG_RuntimeError, " array dim > 2");
  ...
  {
    ("debug: ""float"" *array2d  -> NA_InputArray\n");
    temp13 = obj_to_array_no_conversion(obj5, NPY_FLOAT);
    //PyArrayObject *NAimg  = NA_InputArray(obj5, NPY_FLOAT, NUM_C_ARRAY);
    
    if (!temp13  || !require_contiguous(temp13) || !require_native(temp13)) SWIG_fail;
    
    arg13 = (float *) temp13->data;
    /*@SWIG:Y:/code/PriithonSrc_py25/common\\sebTypemaps2.i,37,MAP_SHAPE2D@*/  switch(temp13->nd) {
    case 1:
      arg14 = temp13->dimensions[0];
      arg15=1;
      break;
    case 2:
      arg14 = temp13->dimensions[1];
      arg15=temp13->dimensions[0];
      break;
    default:
      (" **** array dim >2 (ns=%d)\n", temp13->nd);
      SWIG_exception(SWIG_RuntimeError, " array dim > 2");
...
#endif
    try {
      correct(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20,arg21,arg22,arg23,arg24,arg25,*arg26,*arg27,*arg28,*arg29);
    }
    catch(char *_e) {
      {
  ...
  if (SWIG_IsTmpObj(res26)) {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_From_float((*arg26)));
  } else {
    int new_flags = SWIG_IsNewObj(res26) ? (SWIG_POINTER_OWN |  0 ) :  0 ;
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj((void*)(arg26), SWIGTYPE_p_float, new_flags));
  }
  if (SWIG_IsTmpObj(res27)) {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_From_float((*arg27)));
  } else {
    int new_flags = SWIG_IsNewObj(res27) ? (SWIG_POINTER_OWN |  0 ) :  0 ;
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj((void*)(arg27), SWIGTYPE_p_float, new_flags));
  }
  if (SWIG_IsTmpObj(res28)) {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_From_float((*arg28)));
  } else {
    int new_flags = SWIG_IsNewObj(res28) ? (SWIG_POINTER_OWN |  0 ) :  0 ;
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj((void*)(arg28), SWIGTYPE_p_float, new_flags));
  }
  if (SWIG_IsTmpObj(res29)) {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_From_float((*arg29)));
  } else {
    int new_flags = SWIG_IsNewObj(res29) ? (SWIG_POINTER_OWN |  0 ) :  0 ;
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj((void*)(arg29), SWIGTYPE_p_float, new_flags));
  }
  {
    ("debug: ""Ushort"" *array2d  -> Py_XDECREF\n");
    //CHECK#20060722      Py_XDECREF(temp1);
  }
  {
    ("debug: ""int"" *array1d  -> Py_XDECREF\n");
    //CHECK#20060722     Py_XDECREF(temp4);
  }
  {
    ("debug: ""Ushort"" *array2d  -> Py_XDECREF\n");
    //CHECK#20060722      Py_XDECREF(temp6);
  }
  {
    ("debug: ""float"" *array2d  -> Py_XDECREF\n");
    //CHECK#20060722      Py_XDECREF(temp10);
  }
  {
    ("debug: ""float"" *array2d  -> Py_XDECREF\n");
    //CHECK#20060722      Py_XDECREF(temp13);
  }
  return resultobj;
fail:
  {
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"thrTest", (PyCFunction) _wrap_thrTest, METH_VARARGS | METH_KEYWORDS, (char *)"thrTest(long hEvent, int dt)"},
	 { (char *)"correct", (PyCFunction) _wrap_correct, METH_VARARGS | METH_KEYWORDS, (char *)"\n"
...
static swig_type_info _swigt__p_std__complexT_double_t = {"_p_std__complexT_double_t", "complex64 *|std::complex< double > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__complexT_float_t = {"_p_std__complexT_float_t", "complex32 *|std::complex< float > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_unsigned_char = {"_p_unsigned_char", "unsigned char *|Byte *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_unsigned_int = {"_p_unsigned_int", "DWord *|unsigned int *", 0, 0, (void*)0, 0};
...
SWIGEXPORT void SWIG_init(void) {
  ...
  SWIG_addvarlink(SWIG_globals(),(char*)"count",Swig_var_count_get, Swig_var_count_set);
  SWIG_addvarlink(SWIG_globals(),(char*)"q",Swig_var_q_get, Swig_var_q_set);
}
